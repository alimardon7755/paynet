...
ob_start();
define("uzfox","1199760889:AAHq0eu-_cdJIX2qR8kMxGU41vx-x19zR6w");
$admin = "1139073652";
$botname = "MegaPaynetRobot";
...
"inline_keyboard"=>[
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/TARJIMAKINOLA_HD_UZBFILM"],],
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/UJASKINOLA_HD"],],
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/FANTASTICFILMSHD"],],
...
uzfox("sendPhoto",[
    "chat_id"=>$chatid,
"photo"=>"https://t.me/baaabtu/4",
    "caption"=>"✅ <b>Mega Paynet tizimining rasmiy boti</b> 🤖\n\n🎈 $username do'stingizdan unikal havola-taklifnoma.\n\n👇 Boshlash uchun bosing:
...
"parse_mode"=>"markdown",
       ...
       uzfox("sendMessage",[
              ...
              "parse_mode"=>"html",
               "reply_markup"=>json_encode([   
   "inline_keyboard"=>[
[["text"=>"👨‍💻 Admin","url"=>"https://telegram.me/cptzalatoy"],["text"=>"👥 Kanalimiz","url"=>"https://t.me/Tarjimakinola_hd_uzbfilm"],],
]
]),
]);
}
...
"disable_web_page_preview"=>true,
"parse_mode"=>"html",
"message_text"=>"✅ <b>Mega Paynet tizimining rasmiy boti</b> 🤖\n\n🎈 $username do'stingizdan unikal havola-taklifnoma.\n\n👇 Boshlash uchun bosing:
...
uzfox("sendMessage",[
   "chat_id"=>$chatid,
   "text"=>"Nima haqida yozmoqchisiz? 😊\n\n<b>📞 Aloqa markazi:</b> @CptZalatoy",
"parse_mode"=>"html",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"🗣 Bog'lanish","url"=>"https://t.me/CptZalatoy"],],
]
]),
]);
}
